...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='ros_gz_sim',
            executable='create',
            arguments=['-name', 'human', '-file', os.path.join(pkg_share, 'models', 'human_model', 'model.sdf'), '-world', 'empty', '-x', '1.3', '-y', '-11.5', '-z', '0.67', '-Y', '-1.57'],
            output='screen'
        ),
        ...
        Node(
            ...
            arguments=[
                ...
                '/enable_centering@std_msgs/msg/Bool[gz.msgs.Bool'
